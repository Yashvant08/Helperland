...
var ServiceHistoryController = /** @class */ (function () {
    function ServiceHistoryController(serviceHistoryService) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.serviceHistoryService.getCustomerWorkedWithHelper(req.body.userId)];
                    case 1:
                        customers = _a.sent();
                        if (customers) {
        ...
        this.createBlockUnblockCustomer = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (req.body.userTypeId === 3 && req.body.userId) {
                    req.body.TargetUserId = req.params.userId;
                    if (req.body.IsBlocked) {
                        return [2 /*return*/, this.serviceHistoryService.getBlockedCustomer(req.body.userId, req.params.userId)
