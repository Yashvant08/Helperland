...
var ServiceHistoryService = /** @class */ (function () {
    ...
    ServiceHistoryService.prototype.getBlockedCustomer = function (helperId, customerId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.serviceHistoryRepository.getBlockedCustomer(parseInt(helperId), parseInt(customerId))];
            });
        });
    };
    ServiceHistoryService.prototype.getCustomerWorkedWithHelper = function (helperId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        customer = [];
                        return [4 /*yield*/, this.serviceHistoryRepository.getCustomerWorkedWithHelper(helperId)];
                    case 1:
