...
var ServiceRequestService = /** @class */ (function () {
    ...
    ;
    ServiceRequestService.prototype.getAllPendingServiceRequestByZipcode = function (zipCode, helperId) {
        return __awaiter(this, void 0, void 0, function () {
            var sRequest, serviceRequest, blockedCustomer;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sRequest = [];
                        return [4 /*yield*/, this.serviceRequestRepository.getAllPendingServiceRequestByZipcode(zipCode)];
                    case 1:
                        serviceRequest = _a.sent();
                        return [4 /*yield*/, this.serviceRequestRepository.getBlockedCustomerOfhelper(parseInt(helperId))];
                    case 2:
                        blockedCustomer = _a.sent();
                        if (serviceRequest) {
                            if (blockedCustomer) {
                                sRequest = serviceRequest.filter(function (sr) {
                                    return !blockedCustomer.find(function (rm) {
                                        return (rm.TargetUserId === sr.UserId);
                                    });
                                });
                            }
                        }
                        return [2 /*return*/, sRequest];
                }
            });
        });
    };
    ...
    ServiceRequestService.prototype.displayRequestDetail = function (srequest) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        sr = _a[_i];
                        return [4 /*yield*/, this.serviceRequestRepository.getUserDetailById(srequest[sr].UserId)];
                    case 2:
                        user = _c.sent();
                        return [4 /*yield*/, this.serviceRequestRepository.getRequestAddress(srequest[sr].ServiceRequestId)];
                    case 3:
