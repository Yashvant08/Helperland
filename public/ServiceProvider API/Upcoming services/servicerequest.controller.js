...
var ServiceRequestController = /** @class */ (function () {
    function ServiceRequestController(serviceRequestService) {
                                ...
                                if (helper) {
                                    if (helper.ZipCode === null) {
                                        ...
                                        return _this.serviceRequestService
                                            .getAllPendingServiceRequestByZipcode(helper.ZipCode)
                                            .then(function (serviceRequests) {
                                            if (serviceRequests) {
                                                var sRequests = _this.serviceRequestService.filterServiceRequestsCompatibleWithHelper(req.body.PetsAtHome, serviceRequests);
                                                return res.status(200).json(sRequests);
                                            }
                                            else {
                                                return res
                                                    .status(404)
                ...
                if (req.body.userTypeId === 3) {
                    return [2 /*return*/, this.serviceRequestService
                            ...
                            if (serviceRequestDetail) {
                                ...
                                return res.status(200).json({ message: "request detail not available" });
                            }
                        })
                            .catch(function (error) {
                            console.log(error);
        ...
        this.acceptNewServiceRequest = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, this.serviceRequestService.acceptNewServiceRequest(req.params.requestId, req.body.userId)
                        .then(function (updatedServiceRequest) {
                        if (updatedServiceRequest[0] === 1) {
                            return _this.serviceRequestService.getHelpersByZipCode(req.body.ZipCode)
