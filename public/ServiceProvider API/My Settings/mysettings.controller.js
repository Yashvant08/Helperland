...
var MySettingsController = /** @class */ (function () {
    function MySettingsController(mySettingsService) {
        ...
        this.updateUserDetailById = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (req.body.userId && req.body.userTypeId === 3) {
                    ...
                    return [2 /*return*/, this.mySettingsService.updateUserDetailbyId(req.body.userId, req.body)
        ...
        this.updateOrCreateAddress = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var UserId;
            var _this = this;
            return __generator(this, function (_a) {
                UserId = parseInt(req.body.userId);
                if (UserId && req.body.userTypeId === 3) {
                    return [2 /*return*/, this.mySettingsService.getHelperAddressById(UserId)
                            .then(function (userAddress) {
                            if (userAddress) {
                                return _this.mySettingsService.updateUserAddress(userAddress.AddressId, req.body)
                                ...
                                return _this.mySettingsService.createAddress(UserId, req.body)
