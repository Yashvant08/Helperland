...
var ServiceRequestService = /** @class */ (function () {
    ...
    ServiceRequestService.prototype.createDataForRescheduleSR = function (userEmail, body) {
        var data = {
            from: 'yashvantdesai7@gmail.com',
            to: userEmail,
    ...
    ServiceRequestService.prototype.createDataForUpdatedAddress = function (userEmail, address) {
        var data = {
            from: 'yashvantdesai7@gmail.com',
            to: userEmail,
    ...
    ServiceRequestService.prototype.createDataForUpdatedServiceRequest = function (userEmail, address) {
        var data = {
            from: 'yashvantdesai7@gmail.com',
            to: userEmail,
    ...
    ServiceRequestService.prototype.updateServiceRequestAddress = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            var requestAddress, updatedAddress;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.serviceRequestRepository.getServiceRequestAddress(body.ServiceRequestId)];
                    case 1:
                        requestAddress = _a.sent();
                        if (!requestAddress) return [3 /*break*/, 5];
                        if (!(requestAddress.Addressline1 === body.Addressline1 &&
                            ...
                            requestAddress.PostalCode === body.PostalCode)) return [3 /*break*/, 2];
                        updatedAddress = null;
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.serviceRequestRepository.updateServiceRequestAddress(body)];
                    case 3:
    ...
    ServiceRequestService.prototype.checkIfRescheduleDateIsSame = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        isSame = false;
                        return [4 /*yield*/, this.serviceRequestRepository.getServiceRequestById(body.ServiceRequestId)];
                    case 1:
    ...
    ;
    ServiceRequestService.prototype.rescheduleServiceRequest = function (body, userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.serviceRequestRepository.rescheduleServiceRequest(date, body, parseInt(userId))];
                    case 1:
