        ...
        this.getAllServiceRequests = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (req.body.userTypeId === 2 && req.body.userId) {
                    return [2 /*return*/, this.serviceRequestService.getAllServiceRequests()
            ...
            return __generator(this, function (_a) {
                if (req.body.userTypeId === 2) {
                    if (req.params.requestId) {
                        return [2 /*return*/, this.serviceRequestService.getServiceRequestById(req.params.requestId)
                                ...
                                return __generator(this, function (_a) {
                                    if (serviceRequest) {
                                        if (serviceRequest.Status === 3) {
                                            ...
                                            return [2 /*return*/, this.serviceRequestService.updateServiceRequest(req.params.requestId, req.body.userId)
